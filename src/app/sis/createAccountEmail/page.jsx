        ...
        <div className="flex-1 bg-white flex flex-col justify-center items-center py-4 px-4 sm:py-8 sm:px-4">
          <div className="w-full max-w-xs">
            ...
            <form className="w-full">
              <span className="block text-gray-700 mb-2">First Name</span>
                <input
                    type="text"
                ...
                />
              <span className="block text-gray-700 mb-2">Last Name</span>
                <input
                    type="text"
              ...
              <div className="relative">
                <span className="block text-gray-700 mb-2">Password</span>
                    ...
                    />
                <button type="button" className="absolute right-2 transform -translate-y-1/2 focus:outline-none" onClick={togglePasswordVisibility}>
                  {showPassword ? (
